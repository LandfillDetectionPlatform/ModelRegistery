...
def image_classification_pipeline():
    load_data_step = load_data(data_dir='C:/Users/Yassine/Documents/Spring 2024/LandfillDetection/LandfillDetection-mlops/imagery', inference=False)
    ...
    evaluate_model_step = evaluate_model(loaders=load_data_step,model=train_model_step)
    model_promoter_step = model_promoter(metrics=evaluate_model_step,precision_threshold=0.8, recall_threshold=0.8)
    log_and_save_step = log_and_save(metrics=evaluate_model_step,model_container=train_model_step,promotion_decision=model_promoter_step,model_path='C:/Users/Yassine/Documents/Spring 2024/LandfillDetection/LandfillDetection-mlops/models')
